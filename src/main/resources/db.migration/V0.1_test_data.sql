...
$BODY$
    DECLARE
        ...
        user_1_email   varchar(16) := 'admin@email.com';
        user_2_email   varchar(16) := 'user1@email.com';
        user_3_email   varchar(16) := 'user2@email.com';
    ...
    BEGIN
        ...
        VALUES (user_1_uuid, user_1_email, 'Ludwig', 'Beethoven',
                crypt('admin', gen_salt('bf', 12)), null, 'ADMIN', true),

               (user_2_uuid, user_2_email, 'Johann', 'Sebastian',
                crypt('user1', gen_salt('bf', 12)), null, 'USER',true),
